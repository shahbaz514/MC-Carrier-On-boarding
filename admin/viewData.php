...
$getSql = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `w9_form` WHERE carrier_id = '".$_GET['view']."'"));
?>
                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="header bg-blue">
                            <h2 class="text-uppercase">
                                Carrier Profile
                                <a href="mutualconcepts.v1.php?edit=<?php echo $_GET['view']; ?>" class="btn btn-warning" style="float: right!important;">
                        ...
                        <div class="body">
                            <?php
                            $dataCarrierProfile = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `carrierprofile` WHERE carrier_id = '".$_GET['view']."'"));
                            ?>
                    ...
                    <div class="card">
                        <div class="header bg-blue">
                            <h2 class="text-uppercase">
                                ...
                                <a href="mutualconcepts.v2.php?edit=<?php echo $_GET['view']; ?>" class="btn btn-warning" style="float: right!important;">
                                    Edit Factoring
                                </a>
                            </h2>
                        </div>
                        <div class="body">
                            <?php
                            $dataFactory = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `factory_info` WHERE carrier_id = '".$_GET['view']."'"));
                            ?>
                            <table class="table table-bordered table-striped">
                                <tr>
                    ...
                    <div class="card">
                        <div class="header bg-blue">
                            <h2 class="text-uppercase">
                                ...
                                <a href="mutualconcepts.v3.php?edit=<?php echo $_GET['view']; ?>" class="btn btn-warning" style="float: right!important;">
                                    Edit Insurance
                                </a>
                            </h2>
                        </div>
                        <div class="body">
                            <?php
                            $dataInsurance = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `insurance_info` WHERE carrier_id = '".$_GET['view']."'"));
                            ?>
                            <table class="table table-bordered table-striped">
                                <tr>
                    ...
                    <div class="card">
                        <div class="header bg-blue">
                            <h2 class="text-uppercase">
                                Equipment
                                <a href="mutualconcepts.v4.php?edit=<?php echo $_GET['view']; ?>" class="btn btn-warning" style="float: right!important;">
                                    Edit Equipment
                                </a>
                            </h2>
                        </div>
                        <div class="body">
                            <?php
                            $dataEquipment = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `equipment_info` WHERE carrier_id = '".$_GET['view']."'"));
                            ?>
                            <table class="table table-bordered table-striped">
                                <tr>
                                    <th>Tractors:</th>
                    ...
                    <div class="card">
                        <div class="header bg-blue">
                            <h2 class="text-uppercase">
                                W9-Form Data
                                <a href="mutualconcepts.v6.php?edit=<?php echo $_GET['view']; ?>" class="btn btn-warning" style="float: right!important;">
                                    Edit W9-Form
                                </a>
                            </h2>
                        </div>
                        <div class="body">
                            <?php
                            $dataWForm = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `w9_form` WHERE carrier_id = '".$_GET['view']."'"));
                            ?>
                            <table class="table table-bordered table-striped">
                                <tr>
                    ...
                    <div class="card">
                        <div class="header bg-blue">
                            <h2 class="text-uppercase">
                                Uploaded Documents
                                <a href="mutualconcepts.v7.php?edit=<?php echo $_GET['view']; ?>" class="btn btn-warning" style="float: right!important;">
                                    Edit Documents
                                </a>
                            </h2>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <?php
                                        $i = 0;
                                        $getSqlDoc = mysqli_query($db, "SELECT * FROM `documents` WHERE carrier_id = '".$_GET['view']."'");
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <a href="finalizedData.php?edit=<?php echo $_GET['view']; ?>" class="btn bg-orange form-control waves-button">
                                        Finalized Data
                                    </a>
                                </div>
                                <div class="col-sm-4"></div>
