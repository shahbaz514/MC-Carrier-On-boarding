                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" pattern="\d*" maxlength="6" name="tin_no" value="<?php echo @$getSql['tin_no']; ?>"  class="form-control" placeholder="" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {
                                        $getDataRows = 0;
                                        $getDataRows = mysqli_num_rows(mysqli_query($db, "SELECT * FROM `w9_form` WHERE carrier_id = '".$_GET['edit']."'"));
                                        ...
                                        if ($getDataRows>0)
                                        {
                                            $sqlCountData = mysqli_query($db, "UPDATE `w9_form` SET `name`='$name',`business_name`='$business_name',`fed_tex_classification`='$fed_tex_classification',`limited_ability`='$limited_ability',`examption_code`='$examption_code',`examption_from_fatca`='$examption_from_fatca',`address`='$address',`city_state_zipcode`='$city_state_zipcode',`account_number`='$account_number',`requester_name_address`='$requester_name_address',`tin`='$tin',`tin_no`='$tin_no' WHERE carrier_id = '".$_GET['edit']."'");
                                        }
                                        else
                                        {
                                            $sqlCountData = mysqli_query($db, "INSERT INTO `w9_form`(`carrier_id`, `name`, `business_name`, `fed_tex_classification`, `limited_ability`, `examption_code`, `examption_from_fatca`, `address`, `city_state_zipcode`, `account_number`, `requester_name_address`, `tin`, `tin_no`) VALUES ('".$_GET['edit']."', '$name','$business_name','$fed_tex_classification','$limited_ability','$examption_code','$examption_from_fatca','$address','$city_state_zipcode','$account_number','$requester_name_address','$tin','$tin_no')");
                                        }
