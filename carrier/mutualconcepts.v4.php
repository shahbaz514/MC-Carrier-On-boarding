...
$getSql = mysqli_fetch_array(mysqli_query($db, "SELECT * FROM `equipment_info` WHERE carrier_id = '".$_SESSION['carrier_id']."'"));
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <a href="mutualconcepts.v3.php?edit" class="btn bg-orange waves-effect">
                                            Go to Previous Page
                                        </a>
                                    </form>
                                    <?php
